                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div id="divForTypeaheadStudent">
                                <input class="form-control typeahead jsInputTypeaheadStudent" type="text" placeholder="Search Student..." autocomplete="off">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div id="divForTypeaheadRequest">
                                <input class="form-control typeahead jsInputTypeaheadRequest" type="text" placeholder="Search Request..." autocomplete="off">
                            </div>
